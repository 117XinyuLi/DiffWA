...
def main():
    ...
    if not use_distance_guidance:
        data_reconstructed = process.conditional_sampling(encoded, only_final=True)
    else:
    ...
    # DDPM 0.963 DDIM 0.944 only conditional
    # DDPM 0.975 DDIM 0.980 conditional + distance guidance
    print('SSIM(encoded recon): ', ssim(encoded, data_reconstructed).item())
    # DDPM 0.968 DDIM 0.951 only conditional
    # DDPM 0.980 DDIM 0.982 conditional + distance guidance
    ...
    # DDPM 31.06 DDIM 28.05 only conditional
    # DDPM 32.43 DDIM 32.42 conditional + distance guidance
    print('PSNR(encoded recon): ', psnr(encoded, data_reconstructed).item())
    # DDPM 29.72 DDIM 27.75 only conditional
    # DDPM 31.84 DDIM 32.71 conditional + distance guidance
    ...
    # DDPM 0.453 DDIM 0.448 only conditional
    # DDPM 0.476 DDIM 0.462 conditional + distance guidance
    ...
    # DDPM 0.549 DDIM 0.587 only conditional
    # DDPM 0.578 DDIM 0.602 conditional + distance guidance
