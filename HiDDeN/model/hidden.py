...
class Hidden(nn.Module):
    def __init__(self, configuration: HiDDenConfiguration, device: torch.device, noiser: Noiser):
        ...
        self.discriminator = Discriminator(configuration).to(device)
        self.optimizer_enc_dec = torch.optim.Adam(self.encoder_decoder.parameters(), lr=1e-5, weight_decay=5e-5)
        self.optimizer_discrim = torch.optim.Adam(self.discriminator.parameters(), lr=1e-5, weight_decay=5e-5)
