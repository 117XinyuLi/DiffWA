...
from Hidden_model.discriminator import Discriminator
from Hidden_model.encoder_decoder import EncoderDecoder
from noise_layers.noiser import Noiser


class Hidden(nn.Module):
    def __init__(self, configuration: Configuration, device: torch.device, noiser: Noiser):
        """
    ...
    def train_on_batch(self, batch: list):
        ...
        with torch.enable_grad():
            ...
            detached_encoded_images = encoded_images.detach()
            d_on_encoded = self.discriminator(detached_encoded_images)
